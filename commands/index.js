...
// Cache para as imagens proxyficadas (1 dia)
...
app.get('/img', async (req, res) => {
  ...
  'lh3.googleusercontent.com'
    ...
    if (!r.ok) {      
      console.warn(`[Proxy] Upstream error ${r.status} for ${url}`);
    ...
    console.log(`[Proxy] Fetching ${url} (Content-Type: ${ct})`);
...
<body>
  ...
  <div class="box">
    <div class="box-header">
      ...
      <div>
        <div class="box-header-title">✨ Entrevista</div>
